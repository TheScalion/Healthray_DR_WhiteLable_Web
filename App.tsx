...
const API_BASE = 'https://node.theheritagehospitals.com';

const WEB_BASE = 'https://ray.theheritagehospitals.com';
  ...
  const handleMessage = async (event: any) => {
    try {
      ...
      if (message?.type === 'WEB_AUTH_TOKENS') {
        ...
        if (nativeFcmToken) {
          // TEMP DIAGNOSTIC: skip refresh_token to test whether it invalidates
          // the web session's own device_token and causes instant auto-logout.
          // await syncDeviceToken(nativeFcmToken);
          console.log('[WEB_AUTH_TOKENS] ⚠ TEMP DIAGNOSTIC — syncDeviceToken() skipped on purpose');
        } else {
